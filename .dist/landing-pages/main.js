...
const T = {
  en: {
    ...
    'hero.btn1':'The Architecture','hero.btn2':'Source Code',
    ...
    'nav.hero':'Hero','nav.why':'Problem','nav.cap':'Capabilities','nav.compare':'Comparison','nav.tech':'Architecture','nav.try':'Try today',
  },
  es: {
    ...
    'hero.btn1':'La Arquitectura','hero.btn2':'Código Fuente',
    ...
    'footer':'© 2026 LuAI','topnav.github':'GitHub →',
    'nav.hero':'Inicio','nav.why':'Problema','nav.cap':'Capacidades','nav.compare':'Comparación','nav.tech':'Arquitectura','nav.try':'Pruébalo',
  },
  fr: {
    ...
    'hero.btn1':"L'Architecture",'hero.btn2':'Code Source',
    ...
    'footer':'© 2026 LuAI','topnav.github':'GitHub →',
    'nav.hero':'Accueil','nav.why':'Problème','nav.cap':'Capacités','nav.compare':'Comparaison','nav.tech':'Architecture','nav.try':'Essayer',
  },
  it: {
    ...
    'hero.btn1':"L'Architettura",'hero.btn2':'Codice Sorgente',
    ...
    'footer':'© 2026 LuAI','topnav.github':'GitHub →',
    'nav.hero':'Home','nav.why':'Problema','nav.cap':'Capacità','nav.compare':'Confronto','nav.tech':'Architettura','nav.try':'Prova',
  },
  pt: {
    'hero.kicker':'IA Conversacional · Widgets de UI',
    ...
    'hero.btn1':'A Arquitetura','hero.btn2':'Código Fonte',
    ...
    'footer':'© 2026 LuAI','topnav.github':'GitHub →',
    'nav.hero':'Início','nav.why':'Problema','nav.cap':'Capacidades','nav.compare':'Comparação','nav.tech':'Arquitetura','nav.try':'Experimentar',
  },
  de: {
    ...
    'hero.btn1':'Die Architektur','hero.btn2':'Quellcode',
    ...
    'footer':'© 2026 LuAI','topnav.github':'GitHub →',
    'nav.hero':'Start','nav.why':'Problem','nav.cap':'Fähigkeiten','nav.compare':'Vergleich','nav.tech':'Architektur','nav.try':'Ausprobieren',
  },
  zh: {
    ...
    'footer':'© 2026 LuAI','topnav.github':'GitHub →',
    'nav.hero':'首页','nav.why':'问题','nav.cap':'能力','nav.compare':'对比','nav.tech':'架构','nav.try':'体验',
  },
  ja: {
    ...
    'hero.btn1':'アーキテクチャ','hero.btn2':'ソースコード',
    ...
    'footer':'© 2026 LuAI','topnav.github':'GitHub →',
    'nav.hero':'トップ','nav.why':'課題','nav.cap':'機能','nav.compare':'比較','nav.tech':'アーキテクチャ','nav.try':'試す',
  },
  ar: {
    ...
    'hero.btn1':'البنية التقنية','hero.btn2':'الكود المصدري',
    ...
    'footer':'© 2026 LuAI','topnav.github':'GitHub →',
    'nav.hero':'الرئيسية','nav.why':'المشكلة','nav.cap':'الإمكانيات','nav.compare':'المقارنة','nav.tech':'البنية','nav.try':'جرّب',
  },
};
